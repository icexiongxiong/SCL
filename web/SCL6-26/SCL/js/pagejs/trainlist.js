...
var limit = 5;
var pageData;
var trainlistapp = angular.module('trainlist', ['CommonApp']);
trainlistapp.controller('trainlistcontroller', function($scope, $http, URLParam) {
	...
	$scope.editkh = function(id) {
		window.location.href = "edittrain.html?id=" + id;
