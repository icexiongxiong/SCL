...
var addtrainapp=angular.module('addtrain',['CommonApp']);
addtrainapp.controller('addtraincontroller',function($scope,$http,URLParam){
	$(function() {
...
//      var zhuceleixing=$("#selectError option:selected").val(); //取的企业类型id --nature_id
        ...
        $.ajax({
        	...
        	data:{
        	    ...
        	    "fund":zhucezijin,    //资金
        	    "registertype":zhuceleixingzhi,   //注册类型
