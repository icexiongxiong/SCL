...
var name;
var companyid;
var authendetailsapp = angular.module('authendetails', ['CommonApp']);
authendetailsapp.controller('authendetailscontroller', function($scope, $http, URLParam) {
	...
	$scope.editkh = function(id, companyid) {
		window.location.href = "editauthendetail.html?id=" + id + "&companyid=" + companyid;
	}
