...
var keshiname;
var renyuanname;
var consultlistapp = angular.module('consultlist', ['CommonApp']);
consultlistapp.controller('consultlistcontroller', function($scope, $http, URLParam) {
	...
	$("#keshi").change(function() {
		...
		industrykind = $("#industrykind option:selected").text();
		industrykind = $.trim(industrykind);
...
//				"industrykind":industrykind
	...
	$scope.addxq = function(id, companyname) {
		window.location.href = "addconsultdetail.html?id=" + id + "&name=" + companyname;

	}

	$scope.editkh = function(id) {
		window.location.href = "editconsult.html?id=" + id;
