...
var start = 0;
var pageData;
var projectlistapp = angular.module('projectlist', ['CommonApp']);
projectlistapp.controller('projectlistcontroller', function($scope, $http, URLParam) {
	...
	$scope.addxq = function(id, companyname) {
		window.location.href = "addprojectdetail.html?id=" + id + "&name=" + companyname;
