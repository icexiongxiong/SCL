...
var start = 0;
var pageData;
var collectlistapp = angular.module('collectlist', ['CommonApp']);
collectlistapp.controller('collectlistcontroller', function($scope, $http, URLParam) {
	...
	$scope.editkh = function(id) {
		window.location.href = "editcollect.html?id=" + id;
	...
	$scope.delkh = function(id) {
		...
		$.ajax({
			url: yh + "/collectticket/delete/" + id,
			xhrFields: {
				withCredentials: true
			},
