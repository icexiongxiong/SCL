...
var start = 0;
var pageData;
var weblistapp = angular.module('weblist', ['CommonApp']);
weblistapp.controller('weblistcontroller', function($scope, $http, URLParam) {
	...
	$scope.addxq = function(id, companyname) {
		window.location.href = "addwebdetail.html?id=" + id + "&name=" + companyname;

	}

	$scope.editkh = function(id) {
		window.location.href = "editweb.html?id=" + id;
