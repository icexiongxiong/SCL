...
var name;
var companyid;
var webdetailsapp = angular.module('webdetails', ['CommonApp']);
webdetailsapp.controller('webdetailscontroller', function($scope, $http, URLParam) {
	...
	$scope.editkh = function(id, companyid) {
		window.location.href = "editwebdetail.html?id=" + id + "&companyid=" + companyid;
	}
