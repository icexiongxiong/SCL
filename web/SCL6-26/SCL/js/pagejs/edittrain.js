var id;
var param;
var edittrainapp = angular.module('edittrain', ['CommonApp']);
edittrainapp.controller('edittraincontroller', function($scope, $http, URLParam) {
		...
		$.ajax({
			...
			success: function(response) {
				if(response.success == true) {
					...
					$('#selectError option:selected').text($scope.dataRoot.registertype); //注册类型
					...
					$('#lianxiren').val($scope.dataRoot.person);
